...
const Controls: React.FC<WordCloudControls> = ({
  ...
  return (
    <div 
      className={`fixed bottom-4 ${positionClass} bg-black/20 backdrop-blur-md rounded-lg shadow-lg text-white
                  max-h-[90vh] overflow-y-auto transition-all duration-300 z-10
